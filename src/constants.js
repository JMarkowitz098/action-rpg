...
export const ENEMY_SPRITE_PANEL_WIDTH = 48
export const ENEMY_SPRITE_PANEL_HEIGHT = 62
...
export const HERO_SPRITE_PANEL_WIDTH = 48
export const HERO_SPRITE_PANEL_HEIGHT = 62
